...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/task-builder/sections', [AdminTaskBuilderController::class, 'storeSection'])->middleware('can:dashboard.admin')->name('task-builder.sections.store');
    Route::delete('/task-builder/sections/{section}', [AdminTaskBuilderController::class, 'destroySection'])->middleware('can:dashboard.admin')->name('task-builder.sections.destroy');
    Route::post('/task-builder/sections/{section}/tasks', [AdminTaskBuilderController::class, 'storeTask'])->middleware('can:dashboard.admin')->name('task-builder.tasks.store');
    Route::delete('/task-builder/tasks/{task}', [AdminTaskBuilderController::class, 'destroyTask'])->middleware('can:dashboard.admin')->name('task-builder.tasks.destroy');
    ...
    Route::get('/applications/{application}', [AdminApplicationController::class, 'show'])->middleware('can:dashboard.admin')->name('applications.show');
    Route::patch('/applications/{application}/assign-reviewer', [AdminApplicationController::class, 'assignReviewer'])->middleware('can:dashboard.admin')->name('applications.assign-reviewer');
...
Route::middleware(['auth', 'verified'])->prefix('reviewer')->name('reviewer.')->group(function () {
    ...
    Route::post('/tasks/{task}/approve', [ReviewerApplicationController::class, 'approve'])->name('tasks.approve');
    Route::post('/tasks/{task}/reject', [ReviewerApplicationController::class, 'rejectById'])->name('tasks.reject');
