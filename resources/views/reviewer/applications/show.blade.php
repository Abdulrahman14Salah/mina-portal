<x-reviewer-layout>
    <div class="py-12">
        <div class="max-w-4xl mx-auto space-y-6 sm:px-6 lg:px-8">
                                ...
                                <li class="flex flex-col gap-2 py-3 text-sm sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400 flex items-center gap-2">
                                            <span>{{ $doc->task->name }} · {{ $doc->created_at->format('d M Y') }} · {{ $doc->uploader->name }}</span>
            ...
            @can('reviewerUpload', App\Models\Document::class)
            <div class="space-y-4">
                ...
                <div class="rounded-lg bg-white p-6 shadow-sm">
                    <form method="POST" action="{{ route('reviewer.applications.documents.store', $application) }}" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            <input id="upload-file" type="file" name="file" accept=".pdf,.jpg,.jpeg,.png"
