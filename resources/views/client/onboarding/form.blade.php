        ...
        <form method="POST" action="{{ route('onboarding.store') }}" class="space-y-6">
            ...
            <div x-show="step === 1" x-cloak class="space-y-4">
                ...
                <div class="flex justify-end">
                    <button type="button" @click="step = 2" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ms-3">{{ __('client.next') }}</button>
                </div>
            </div>
            ...
            <div x-show="step === 2" x-cloak class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    <button type="button" @click="step = 3" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ms-3">{{ __('client.next') }}</button>
                </div>
            </div>
